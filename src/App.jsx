...
const INIT=[
  {id:"1",day:0,name:"Intelligentsia Coffee",cat:"Coffee",desc:"Ease into Chicago with the city's pioneering third-wave roaster. Try the Black Cat espresso.",loc:"53 E Randolph St",time:"09:00",img:"https://images.unsplash.com/photo-1595928642581-f50f4f3453a5?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixlib=rb-4.1.0&q=80&w=600"},
  {id:"2",day:2,name:"Millennium Park & Cloud Gate",cat:"Activities",desc:"A relaxed walk to see the iconic Bean, Lurie Garden, and Crown Fountain. Free admission.",loc:"201 E Randolph St",time:"14:00",img:"https://images.unsplash.com/photo-1599769422132-d52e5214277d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixlib=rb-4.1.0&q=80&w=600"},
  {id:"3",day:5,name:"Nadu",cat:"Restaurants",desc:"South Indian cuisine — dosas, uttapam, and thalis. Excellent vegetarian selection. ~$100 for three.",loc:"2423 N Clark St, Lincoln Park",time:"19:00",img:"https://images.unsplash.com/photo-1668236543090-82eba5ee5976?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixlib=rb-4.1.0&q=80&w=600"},
  {id:"4",day:7,name:"Metric Coffee",cat:"Coffee",desc:"Minimalist roastery in Fulton Market. Single-origin pourovers in an industrial-chic space.",loc:"2021 W Fulton St",time:"10:00",img:"https://images.unsplash.com/photo-1770579673873-8da37e35d54e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixlib=rb-4.1.0&q=80&w=600"},
  {id:"5",day:8,name:"Planta",cat:"Restaurants",desc:"Upscale plant-based dining. Creative sushi, truffle pizza, and craft cocktails. ~$130 for three.",loc:"18 E Bellevue Pl, Gold Coast",time:"19:30",img:"https://images.unsplash.com/photo-1622115837997-90c89ae689f9?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixlib=rb-4.1.0&q=80&w=600"},
  {id:"6",day:10,name:"Chicago French Market",cat:"Markets",desc:"Indoor European-style market with artisan vendors, fresh produce, and prepared foods.",loc:"131 N Clinton St",time:"11:00",img:"https://images.unsplash.com/photo-1776007699209-5d68bbdfdfcb?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixlib=rb-4.1.0&q=80&w=600"},
  {id:"7",day:12,name:"Revolution Brewing",cat:"Bars",desc:"Chicago's largest independent brewery. Great craft beers on tap — try the Anti-Hero IPA.",loc:"2323 N Milwaukee Ave",time:"17:00",img:"https://images.unsplash.com/photo-1646241651636-49549005a1a3?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixlib=rb-4.1.0&q=80&w=600"},
  {id:"8",day:14,name:"Sawada Coffee",cat:"Coffee",desc:"Military Latte is legendary — matcha meets espresso. Cool West Loop vibes.",loc:"112 N Green St",time:"09:30",img:"https://images.unsplash.com/photo-1561658286-ecb9fe9d8480?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixlib=rb-4.1.0&q=80&w=600"},
  {id:"9",day:15,name:"Art Institute of Chicago",cat:"Activities",desc:"World-class museum — Monet, Seurat, Hopper, and the Thorne Miniature Rooms. Plan 3+ hours.",loc:"111 S Michigan Ave",time:"10:00",img:"https://images.unsplash.com/photo-1554907984-15263bfd63bd?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixlib=rb-4.1.0&q=80&w=600"},
  {id:"10",day:16,name:"Pilsen Food Crawl",cat:"Food Walks",desc:"Vibrant Pilsen — taquerias, bakeries, and amazing street art murals along 18th Street.",loc:"18th St & Blue Island Ave",time:"12:00",img:"https://images.unsplash.com/photo-1638689253215-0e730f5b9e1e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixlib=rb-4.1.0&q=80&w=600"},
  {id:"11",day:17,name:"Strings Ramen",cat:"Restaurants",desc:"Rich tonkotsu and veggie ramen with great sides. Solid vegetarian broth. ~$80 for three.",loc:"2141 N Western Ave",time:"18:30",img:"https://images.unsplash.com/photo-1591814468924-caf88d1232e1?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixlib=rb-4.1.0&q=80&w=600"},
  {id:"12",day:19,name:"Half Acre Beer Company",cat:"Bars",desc:"Beloved neighborhood brewery. Daisy Cutter pale ale is the flagship. Great taproom vibes.",loc:"4257 N Lincoln Ave",time:"16:00",img:"https://images.unsplash.com/photo-1612528443702-f6741f70a049?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixlib=rb-4.1.0&q=80&w=600"},
  {id:"13",day:21,name:"Gaslight Coffee Roasters",cat:"Coffee",desc:"Cozy Logan Square café with house-roasted beans and excellent pastries.",loc:"2385 N Milwaukee Ave",time:"09:00",img:"https://images.unsplash.com/photo-1621343607959-5d11ff0f1e39?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixlib=rb-4.1.0&q=80&w=600"},
  {id:"14",day:22,name:"Architecture Boat Tour",cat:"Activities",desc:"Cruise the Chicago River learning about iconic skyscrapers. A must-do experience.",loc:"112 E Wacker Dr",time:"11:00",img:"https://images.unsplash.com/photo-1548260616-b71c60ccea3a?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixlib=rb-4.1.0&q=80&w=600"},
  {id:"15",day:23,name:"Devon Ave Food Crawl",cat:"Food Walks",desc:"Chicago's Little India — chaat counters, sweet shops, and full-service vegetarian restaurants.",loc:"Devon Ave & Washtenaw",time:"12:00",img:"https://images.unsplash.com/photo-1614435842039-e842b002c342?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixlib=rb-4.1.0&q=80&w=600"},
  {id:"16",day:24,name:"Indienne",cat:"Restaurants",desc:"Fine-dining Indian with a modern twist. Tasting menus and à la carte. Splurge night — ~$200+ for three.",loc:"217 W Huron St, River North",time:"19:00",img:"https://images.unsplash.com/photo-1565556250026-9ba22083e3e0?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixlib=rb-4.1.0&q=80&w=600"},
  ...
  {id:"18",day:26,name:"Lincoln Park Zoo",cat:"Activities",desc:"Free zoo in the heart of Lincoln Park. Lions, gorillas, penguins, and a nature boardwalk.",loc:"2001 N Clark St",time:"10:00",img:"https://images.unsplash.com/photo-1562533603-08d7d0355dba?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixlib=rb-4.1.0&q=80&w=600"},
  {id:"19",day:27,name:"Mott St",cat:"Restaurants",desc:"Asian-inspired shareable plates. Great vegetarian options — coconut rice and mushroom dishes. ~$110 for three.",loc:"1401 N Ashland Ave",time:"19:00",img:"https://images.unsplash.com/photo-1624223875266-81ebbb795584?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixlib=rb-4.1.0&q=80&w=600"},
  {id:"20",day:28,name:"Forbidden Root",cat:"Bars",desc:"Botanical brewery — beers brewed with roots, herbs, and flowers. Unique and delicious.",loc:"1746 W Chicago Ave",time:"17:00",img:"https://images.unsplash.com/photo-1609345265499-2133bbeb6ce5?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixlib=rb-4.1.0&q=80&w=600"},
  {id:"21",day:29,name:"Garfield Park Conservatory",cat:"Activities",desc:"One of the largest conservatories in the US — lush tropical rooms and desert landscapes. Free.",loc:"300 N Central Park Ave",time:"11:00",img:"https://images.unsplash.com/photo-1506277450472-30e3f3f55129?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixlib=rb-4.1.0&q=80&w=600"},
  {id:"22",day:30,name:"Chinatown Food Crawl",cat:"Food Walks",desc:"Dim sum, bubble tea, and bakeries in Chicago's lively Chinatown district.",loc:"Wentworth Ave & Cermak Rd",time:"12:00",img:"https://images.unsplash.com/photo-1563245372-f21724e3856d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixlib=rb-4.1.0&q=80&w=600"},
  {id:"23",day:31,name:"Randolph Street Market",cat:"Markets",desc:"Indoor/outdoor market with vintage finds, antiques, and gourmet food stalls.",loc:"1340 W Washington Blvd",time:"10:00",img:"https://images.unsplash.com/photo-1597668900045-b9283c0de174?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixlib=rb-4.1.0&q=80&w=600"},
  {id:"24",day:32,name:"Handlebar",cat:"Restaurants",desc:"Bike-themed bar & grill with an extensive vegetarian and vegan menu. Casual. ~$70 for three.",loc:"2311 W North Ave",time:"12:30",img:"https://images.unsplash.com/photo-1661257711676-79a0fc533569?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixlib=rb-4.1.0&q=80&w=600"},
  {id:"25",day:32,name:"Chicago Riverwalk",cat:"Activities",desc:"Stroll, dine, and kayak along the scenic downtown river path. Beautiful at sunset.",loc:"Chicago Riverwalk, Wacker Dr",time:"17:00",img:"https://images.unsplash.com/photo-1521901581118-62fa7443883d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixlib=rb-4.1.0&q=80&w=600"},
  {id:"26",day:33,name:"Museum of Science & Industry",cat:"Activities",desc:"Real U-505 submarine, coal mine tour, and hands-on science exhibits. Epic finale day.",loc:"5700 S DuSable Lake Shore Dr",time:"10:00",img:"https://images.unsplash.com/photo-1769664748202-7d2674cb4395?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixlib=rb-4.1.0&q=80&w=600"},
];
